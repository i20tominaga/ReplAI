...
var normalizeIndentListNotIndented = (editor, [node, path]) => {
  if (!(0, import_server11.isDefined)(node[import_plate_indent8.KEY_INDENT]) && (node[KEY_LIST_STYLE_TYPE] || node[KEY_LIST_START])) {
...
var insertBreakIndentList = (editor) => {
  ...
  return function() {
    ...
    if (!(0, import_server16.isDefined)(node[KEY_LIST_STYLE_TYPE]) || node[KEY_LIST_STYLE_TYPE] !== KEY_TODO_STYLE_TYPE)
      return insertBreak();
...
var withIndentList = (editor, { options }) => {
  ...
  editor.apply = (operation) => {
    ...
    if (nodeBefore && operation.type === "set_node") {
      ...
      const prevIndent = operation.properties[import_plate_indent9.KEY_INDENT];
      const indent = operation.newProperties[import_plate_indent9.KEY_INDENT];
...
var useIndentListToolbarButtonState = ({
  ...
  const pressed = (0, import_plate_common.useEditorSelector)(
...
var useIndentTodoToolBarButtonState = ({
  ...
  const pressed = (0, import_plate_common3.useEditorSelector)(
