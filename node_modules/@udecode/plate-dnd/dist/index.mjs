...
var useWithDraggable = ({
  ...
  const filteredOut = React6.useMemo(
    () => path && (Number.isInteger(level) && level !== path.length - 1 || (filter == null ? void 0 : filter(editor, path))),
...
import { findNode, moveNodes } from "@udecode/plate-common/server";
...
import { focusEditor as focusEditor2 } from "@udecode/plate-common";
import {
  collapseSelection,
  isExpanded
...
import { focusEditor as focusEditor3 } from "@udecode/plate-common";
import {
...
import { focusEditor as focusEditor4 } from "@udecode/plate-common";
import {
  removeNodes,
  unhangRange
} from "@udecode/plate-common/server";
...
import { focusEditor as focusEditor5 } from "@udecode/plate-common";
import {
...
import { focusEditor as focusEditor6 } from "@udecode/plate-common";
import {
  select as select3
} from "@udecode/plate-common/server";
