...
import { Value, ENodeEntry, TElement, EElement, EText, EElementOrText, TNodeEntry, TRange, TEditor, THistoryEditor, TText, TDescendant, EDescendant, GetNodeEntriesOptions, TNode, NodeOf, QueryNodeOptions } from '@udecode/slate';
...
declare const withTHistory: <V extends Value = Value, E extends TEditor<V> = TEditor<V>, EE extends E = E & Pick<slate_history.HistoryEditor, "history" | "redo" | "undo" | "writeHistory"> & Omit<slate.BaseEditor, "children" | "operations" | "marks" | "apply" | "getDirtyPaths" | "getFragment" | "markableVoid" | "normalizeNode" | "insertFragment" | "insertNode" | "isInline" | "isVoid" | "id"> & {
    ...
    normalizeNode: <N_8 extends _udecode_slate.TNode>(entry: _udecode_slate.TNodeEntry<N_8>) => void;
 ...
 */
declare const getRenderNodeProps: <V extends Value>({ attributes, nodeProps, props, type, }: {
...
declare const createPlateStore: <V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>>({ decorate, editor, editorRef, id, isMounted, onChange, plugins, primary, rawPlugins, readOnly, renderElement, renderLeaf, value, versionDecorate, versionEditor, versionSelection, ...state }?: Partial<PlateStoreState<V, E>>) => jotai_x.AtomStoreApi<PlateStoreState<V, E>, {
...
interface PlateProps<V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>> extends Partial<Pick<PlateStoreState<V, E>, 'editor' | 'id' | 'primary' | 'readOnly' | 'value'>> {
    children: React__default.ReactNode;
...
export { KEY_EVENT_EDITOR as $, createHistoryPlugin as A, KEY_INLINE_VOID as B, type CreatePlateEditorOptions as C, DefaultLeaf as D, ELEMENT_DEFAULT as E, withInlineVoid as F, GLOBAL_PLATE_SCOPE as G, createInlineVoidPlugin as H, withInsertData as I, KEY_INSERT_DATA as J, KEY_DESERIALIZE_AST as K, createInsertDataPlugin as L, type LengthPlugin as M, type NoInfer as N, type OverrideByKey as O, type PlateChangeKey as P, KEY_LENGTH as Q, type RenderElementFn as R, withLength as S, type TEditableProps as T, type UsePlateEditorStoreOptions as U, createLengthPlugin as V, type WithPlatePlugin as W, KEY_NODE_FACTORY as X, createNodeFactoryPlugin as Y, KEY_PREV_SELECTION as Z, createPrevSelectionPlugin as _, type PlateId as a, pipeDeserializeHtmlLeaf as a$, createEventEditorPlugin as a0, type EventEditorState as a1, eventEditorStore as a2, eventEditorActions as a3, eventEditorSelectors as a4, useEventEditorSelectors as a5, getEventPlateId as a6, CARRIAGE_RETURN as a7, LINE_FEED as a8, NO_BREAK_SPACE as a9, type CollapseWhiteSpaceState as aA, copyBlockMarksToSpanChild as aB, deserializeHtml as aC, deserializeHtmlElement as aD, deserializeHtmlNode as aE, deserializeHtmlNodeChildren as aF, findHtmlElement as aG, someHtmlElement as aH, getHtmlComments as aI, htmlBodyToFragment as aJ, htmlBrToNewLine as aK, htmlElementToElement as aL, htmlElementToLeaf as aM, htmlStringToDOMNode as aN, htmlTextNodeToString as aO, inlineTagNames as aP, isHtmlBlockElement as aQ, isHtmlComment as aR, isHtmlElement as aS, isHtmlFragmentHref as aT, isHtmlInlineElement as aU, isHtmlTable as aV, isHtmlText as aW, isOlSymbol as aX, parseHtmlDocument as aY, parseHtmlElement as aZ, pipeDeserializeHtmlElement as a_, SPACE as aa, TAB as ab, ZERO_WIDTH_SPACE as ac, KEY_DESERIALIZE_HTML as ad, createDeserializeHtmlPlugin as ae, type DeserializeHtmlChildren as af, type DeserializeHtmlNodeReturnType as ag, cleanHtmlBrElements as ah, cleanHtmlCrLf as ai, cleanHtmlEmptyElements as aj, cleanHtmlFontElements as ak, cleanHtmlLinkElements as al, cleanHtmlTextNodes as am, collapseString as an, collapseWhiteSpace as ao, collapseWhiteSpaceChildren as ap, collapseWhiteSpaceElement as aq, collapseWhiteSpaceNode as ar, collapseWhiteSpaceText as as, inferWhiteSpaceRule as at, isLastNonEmptyTextOfInlineFormattingContext as au, upsertInlineFormattingContext as av, endInlineFormattingContext as aw, type WhiteSpaceRule as ax, type TrimStartRule as ay, type TrimEndRule as az, type PlateEditor as b, getPluginOptions as b$, pluginDeserializeHtml as b0, postCleanHtml as b1, preCleanHtml as b2, removeHtmlNodesBetweenComments as b3, removeHtmlSurroundings as b4, replaceTagName as b5, traverseHtmlComments as b6, traverseHtmlElements as b7, traverseHtmlNode as b8, traverseHtmlTexts as b9, type InjectProps as bA, type KeyboardHandler as bB, type KeyboardHandlerReturnType as bC, type OnChange as bD, type PluginOptions as bE, type PlatePluginComponent as bF, type PlatePluginInsertDataOptions as bG, type PlatePluginInsertData as bH, type PluginKey as bI, type PlatePluginKey as bJ, type PlatePluginProps as bK, type RenderAfterEditable as bL, type SerializeHtml as bM, type ToggleMarkPlugin as bN, type WithOverride as bO, type TRenderElementProps as bP, type ApplyDeepToNodesOptions as bQ, applyDeepToNodes as bR, createPluginFactory as bS, createPlugins as bT, flattenDeepPlugins as bU, type InjectedPlugin as bV, getInjectedPlugins as bW, getKeyByType as bX, getKeysByTypes as bY, getPlugin as bZ, getPluginInjectProps as b_, unwrapHtmlElement as ba, resetEditor as bb, resetEditorChildren as bc, type ToggleNodeTypeOptions as bd, toggleNodeType as be, type PlateEditorMethods as bf, type PlateRenderElementProps as bg, type PlateRenderLeafProps as bh, type PlateRenderNodeProps as bi, type PlateStoreState as bj, EXPOSED_STORE_KEYS as bk, type Nullable as bl, DOM_HANDLERS as bm, type HandlerReturnType as bn, type KeyboardEventHandler as bo, type DOMHandlerReturnType as bp, type DOMHandler as bq, type DOMHandlers as br, type DecorateEntry as bs, type Decorate as bt, type DeserializeHtml as bu, type HotkeyPlugin as bv, type InjectComponentProps as bw, type InjectComponentReturnType as bx, type InjectComponent as by, type TransformOptions as bz, type PlateProps as c, getPluginType as c0, getPluginTypes as c1, getPlugins as c2, getPluginsByKey as c3, getRenderNodeProps as c4, mapInjectPropsToPlugin as c5, mergeDeepPlugins as c6, mergeDeepToNodes as c7, getSlateClass as c8, mockPlugin as c9, normalizeDescendantsToDocumentFragment as ca, normalizeInitialValue as cb, overridePluginsByKey as cc, pipeDecorate as cd, convertDomEventToSyntheticEvent as ce, isEventHandled as cf, pipeHandler as cg, pipeInjectProps as ch, pipeInsertDataQuery as ci, pipeInsertFragment as cj, pipeOnChange as ck, pipeTransformData as cl, pipeTransformFragment as cm, type GetInjectPropsOptions as cn, type GetInjectPropsReturnType as co, pluginInjectProps as cp, setDefaultPlugin as cq, createHotkey as cr, sharedHotkeys as cs, withHOC as ct, type PlatePlugin as d, type RenderElement as e, type RenderLeaf as f, Plate as g, type WithPlateOptions as h, PLATE_SCOPE as i, createPlateStore as j, PlateStoreProvider as k, usePlateEditorStore as l, usePlateSelectors as m, usePlateActions as n, usePlateStates as o, plateStore as p, usePlateId as q, createPlateEditor as r, createDeserializeAstPlugin as s, KEY_EDITOR_PROTOCOL as t, usePlateStore as u, withEditorProtocol as v, withPlate as w, createEditorProtocolPlugin as x, KEY_HISTORY as y, withTHistory as z };
