      ...
      ({ validAttribute, validClassName, validNodeName = "*", validStyle }) => {
        ...
        if (validStyle) {
          for (const [key, value] of Object.entries(validStyle)) {
            const values2 = castArray2(value);
...
function DefaultLeaf(_a) {
  ...
  return /* @__PURE__ */ React4.createElement("span", __spreadValues(__spreadValues({}, attributes), props), children);
}
...
var pluginRenderLeaf = (editor, { component, key, props, type = key }) => function render(nodeProps) {
  ...
  if (leaf[type]) {
    ...
    return /* @__PURE__ */ React5.createElement(Leaf, __spreadValues({}, nodeProps), children);
  }
  return children;
};
...
var pipeRenderLeaf = (editor, renderLeafProp) => {
  ...
  return function render(nodeProps) {
    ...
    return /* @__PURE__ */ React6.createElement(DefaultLeaf, __spreadValues({}, props));
  };
};
...
function EditorRefEffect({ id }) {
  ...
  return /* @__PURE__ */ React14.createElement(React14.Fragment, null, plugins.map((plugin) => /* @__PURE__ */ React14.createElement(EditorRefPluginEffect, { id, key: plugin.key, plugin })));
}
