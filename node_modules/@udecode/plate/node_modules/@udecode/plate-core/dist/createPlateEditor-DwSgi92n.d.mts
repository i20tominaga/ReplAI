...
import { Value, ENodeEntry, TElement, EElement, EText, EElementOrText, TText, TNodeEntry, TSelection, TRange, TEditor, THistoryEditor, TDescendant, EDescendant, GetNodeEntriesOptions, TNode, NodeOf, QueryNodeOptions } from '@udecode/slate';
...
import { TRenderLeafProps, RenderLeafFn, TReactEditor } from '@udecode/slate-react';
...
export { FOCUS_EDITOR_EVENT as $, createHistoryPlugin as A, KEY_INLINE_VOID as B, type CreatePlateEditorOptions as C, DefaultLeaf as D, ELEMENT_DEFAULT as E, withInlineVoid as F, GLOBAL_PLATE_SCOPE as G, createInlineVoidPlugin as H, withInsertData as I, KEY_INSERT_DATA as J, KEY_DESERIALIZE_AST as K, createInsertDataPlugin as L, type LengthPlugin as M, type NoInfer as N, type OverrideByKey as O, type PlateChangeKey as P, KEY_LENGTH as Q, type RenderElementFn as R, withLength as S, type TEditableProps as T, type UsePlateEditorStoreOptions as U, createLengthPlugin as V, type WithPlatePlugin as W, KEY_NODE_FACTORY as X, createNodeFactoryPlugin as Y, KEY_PREV_SELECTION as Z, createPrevSelectionPlugin as _, type PlateId as a, collapseString as a$, BLUR_EDITOR_EVENT as a0, KEY_EVENT_EDITOR as a1, createEventEditorPlugin as a2, type EventEditorState as a3, eventEditorStore as a4, eventEditorActions as a5, eventEditorSelectors as a6, useEventEditorSelectors as a7, getEventPlateId as a8, CARRIAGE_RETURN as a9, htmlElementToLeaf as aA, htmlStringToDOMNode as aB, htmlTextNodeToString as aC, inlineTagNames as aD, isHtmlBlockElement as aE, isHtmlComment as aF, isHtmlElement as aG, isHtmlFragmentHref as aH, isHtmlInlineElement as aI, isHtmlTable as aJ, isHtmlText as aK, isOlSymbol as aL, parseHtmlDocument as aM, parseHtmlElement as aN, pipeDeserializeHtmlElement as aO, pipeDeserializeHtmlLeaf as aP, pluginDeserializeHtml as aQ, postCleanHtml as aR, preCleanHtml as aS, removeHtmlNodesBetweenComments as aT, removeHtmlSurroundings as aU, replaceTagName as aV, traverseHtmlComments as aW, traverseHtmlElements as aX, traverseHtmlNode as aY, traverseHtmlTexts as aZ, unwrapHtmlElement as a_, LINE_FEED as aa, NO_BREAK_SPACE as ab, SPACE as ac, TAB as ad, ZERO_WIDTH_SPACE as ae, KEY_DESERIALIZE_HTML as af, createDeserializeHtmlPlugin as ag, type DeserializeHtmlChildren as ah, type DeserializeHtmlNodeReturnType as ai, cleanHtmlBrElements as aj, cleanHtmlCrLf as ak, cleanHtmlEmptyElements as al, cleanHtmlFontElements as am, cleanHtmlLinkElements as an, cleanHtmlTextNodes as ao, copyBlockMarksToSpanChild as ap, deserializeHtml as aq, deserializeHtmlElement as ar, deserializeHtmlNode as as, deserializeHtmlNodeChildren as at, findHtmlElement as au, someHtmlElement as av, getHtmlComments as aw, htmlBodyToFragment as ax, htmlBrToNewLine as ay, htmlElementToElement as az, type PlateEditor as b, getPlugin as b$, collapseWhiteSpace as b0, collapseWhiteSpaceChildren as b1, collapseWhiteSpaceElement as b2, collapseWhiteSpaceNode as b3, collapseWhiteSpaceText as b4, inferWhiteSpaceRule as b5, isLastNonEmptyTextOfInlineFormattingContext as b6, upsertInlineFormattingContext as b7, endInlineFormattingContext as b8, type WhiteSpaceRule as b9, type InjectComponent as bA, type TransformOptions as bB, type InjectProps as bC, type KeyboardHandler as bD, type KeyboardHandlerReturnType as bE, type OnChange as bF, type PluginOptions as bG, type PlatePluginComponent as bH, type PlatePluginInsertDataOptions as bI, type PlatePluginInsertData as bJ, type PluginKey as bK, type PlatePluginKey as bL, type PlatePluginProps as bM, type RenderAfterEditable as bN, type SerializeHtml as bO, type ToggleMarkPlugin as bP, type WithOverride as bQ, type TRenderElementProps as bR, type ApplyDeepToNodesOptions as bS, applyDeepToNodes as bT, createPluginFactory as bU, createPlugins as bV, flattenDeepPlugins as bW, type InjectedPlugin as bX, getInjectedPlugins as bY, getKeyByType as bZ, getKeysByTypes as b_, type TrimStartRule as ba, type TrimEndRule as bb, type CollapseWhiteSpaceState as bc, resetEditor as bd, resetEditorChildren as be, type ToggleNodeTypeOptions as bf, toggleNodeType as bg, type PlateEditorMethods as bh, type PlateRenderElementProps as bi, type PlateRenderLeafProps as bj, type PlateRenderNodeProps as bk, type PlateStoreState as bl, EXPOSED_STORE_KEYS as bm, type Nullable as bn, DOM_HANDLERS as bo, type HandlerReturnType as bp, type KeyboardEventHandler as bq, type DOMHandlerReturnType as br, type DOMHandler as bs, type DOMHandlers as bt, type DecorateEntry as bu, type Decorate as bv, type DeserializeHtml as bw, type HotkeyPlugin as bx, type InjectComponentProps as by, type InjectComponentReturnType as bz, type PlateProps as c, getPluginInjectProps as c0, getPluginOptions as c1, getPluginType as c2, getPluginTypes as c3, getPlugins as c4, getPluginsByKey as c5, getRenderNodeProps as c6, mapInjectPropsToPlugin as c7, mergeDeepPlugins as c8, mergeDeepToNodes as c9, mockPlugin as ca, normalizeDescendantsToDocumentFragment as cb, normalizeInitialValue as cc, overridePluginsByKey as cd, pipeDecorate as ce, convertDomEventToSyntheticEvent as cf, isEventHandled as cg, pipeHandler as ch, pipeInjectProps as ci, pipeInsertDataQuery as cj, pipeInsertFragment as ck, pipeOnChange as cl, pipeTransformData as cm, pipeTransformFragment as cn, type GetInjectPropsOptions as co, type GetInjectPropsReturnType as cp, pluginInjectProps as cq, setDefaultPlugin as cr, createHotkey as cs, sharedHotkeys as ct, withHOC as cu, getSlateClass as cv, type PlatePlugin as d, type RenderElement as e, type RenderLeaf as f, Plate as g, type WithPlateOptions as h, PLATE_SCOPE as i, createPlateStore as j, PlateStoreProvider as k, usePlateEditorStore as l, usePlateSelectors as m, usePlateActions as n, usePlateStates as o, plateStore as p, usePlateId as q, createPlateEditor as r, createDeserializeAstPlugin as s, KEY_EDITOR_PROTOCOL as t, usePlateStore as u, withEditorProtocol as v, withPlate as w, createEditorProtocolPlugin as x, KEY_HISTORY as y, withTHistory as z };
